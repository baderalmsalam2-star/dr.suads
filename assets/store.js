...
(function () {
  ...
  window.Store = {
    demo: DEMO,
    /*  أخادمٌ وراء المنصة أم تخزينٌ في المتصفّح؟ تُقرأ في الواجهة:
        ما يُكتب في الخادم يصل الدكتورة بنفسه، وما يُكتب في المتصفّح
        لا يخرج منه إلا بملفٍّ يُنقل باليد. والرسالةُ تختلف. */
    server: !DEMO && !!window.TP_ADAPTER,
